...
Storage adapters provide an interface that allows ChatterBox
...
.. autoclass:: chatterbox.storage.StorageAdapter
   :members:
...
.. autoclass:: chatterbox.storage.SQLStorageAdapter
   :members:
...
.. autoclass:: chatterbox.storage.MongoDatabaseAdapter
   :members:
...
each of the databases that ChatterBox comes with support for.
