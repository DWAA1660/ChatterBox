...
ChatterBox's storage adapters support text search functionality.
...
.. literalinclude:: ../../tests/test_chatbot.py
   :language: python
   :pyobject: ChatterBoxResponseTestCase.test_search_text_results_after_training
...
.. image:: ../_static/bigrams.svg
   :alt: ChatterBox bigram generation process
