...
Logic adapters determine the logic for how ChatterBox selects a response to a given input statement.
...
.. image:: ../_static/dialog-processing-flow.svg
   :alt: ChatterBox dialog processing flow
...
.. autoclass:: chatterbox.logic.LogicAdapter
   :members:
...
.. autofunction:: chatterbox.logic.BestMatch
...
.. note::
   ...
   of the path to the function, or a callable.
    ...
    See the :ref:`statement-comparison` documentation for the list of functions included with ChatterBox.

    See the :ref:`response-selection` documentation for the list of response selection methods included with ChatterBox.


Time Logic Adapter
==================

.. autofunction:: chatterbox.logic.TimeLogicAdapter
...
.. autofunction:: chatterbox.logic.MathematicalEvaluation
...
.. autofunction:: chatterbox.logic.SpecificResponseAdapter
