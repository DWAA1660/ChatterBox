...
are built into ChatterBox for selecting a response from the
available options.
...
.. automodule:: chatterbox.response_selection
   :members:
...
.. code-block:: python
   ...
   from chatterbox.response_selection import get_most_frequent_response
