...
As the code for ChatterBox is written, the developers attempt to describe
...
information is unnecessary for the typical developer using ChatterBox.
...
.. toctree::
    ...
    contributing
    releases
    Release Notes <https://github.com/gunthercox/ChatterBox/releases>
    testing
    packaging
...
To help developers work with ChatterBox and projects built using it, the
