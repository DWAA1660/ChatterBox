...
ChatterBox is a Python library that makes it easy to generate automated
responses to a user's input. ChatterBox uses a selection of machine learning
...
For more details about the ideas and concepts behind ChatterBox see the
...
The language independent design of ChatterBox allows it to be trained to speak any language.
Additionally, the machine-learning nature of ChatterBox allows an agent instance to improve
...
ChatterBox is a Python library designed to make it easy to create software that can engage in conversation.

An :term:`untrained instance` of ChatterBox starts off with no knowledge of how to communicate.
Each time a user enters a :term:`statement`, the library saves the text that they entered and the text
that the statement was in response to. As ChatterBox receives more input the number of responses
...
.. image:: _static/chatterbox-process-flow.svg
   :alt: ChatterBox process flow diagram
...
.. _GitHub: https://github.com/gunthercox/ChatterBox/issues/
