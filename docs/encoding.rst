...
Does ChatterBox handle non-ascii characters?
============================================

ChatterBox is able to handle unicode values correctly. You can pass to it
...
Below is one of ChatterBox's tests from `tests/test_chatbot.py`_,
...
ChatterBox *can* take unicode input without issue.
...
.. _`tests/test_chatbot.py`: https://github.com/gunthercox/ChatterBox/blob/master/tests/test_chatbot.py
