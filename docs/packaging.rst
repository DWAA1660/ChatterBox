==================================
Packaging your code for ChatterBox
==================================

There are cases where developers may want to contribute code to ChatterBox but for
various reasons it doesn't make sense or isn't possible to add the code to the
main ChatterBox repository on GitHub.

Common reasons that code can't be contributed include:

- Licencing: It may not be possible to contribute code to ChatterBox due to a licencing restriction or a copyright.
...
Suppose we want to create a new logic adapter for ChatterBox and add it the
...
If you are creating a module that ChatterBox imports from a dotted module path then you
