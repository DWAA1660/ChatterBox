...
from chatterbox import preprocessors
...
class CleanWhitespacePreprocessorTestCase(ChatBotTestCase):
    """
    Make sure that ChatterBox's whitespace removing preprocessor works as expected.
    """
...
class HTMLUnescapePreprocessorTestCase(ChatBotTestCase):
    """
    Make sure that ChatterBox's html unescaping preprocessor works as expected.
    """
...
class ConvertToASCIIPreprocessorTestCase(ChatBotTestCase):
    """
    Make sure that ChatterBox's ASCII conversion preprocessor works as expected.
    """
