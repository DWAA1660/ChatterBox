...
from chatterbox.conversation import Statement
from chatterbox.tagging import PosLemmaTagger
...
class Trainer(object):
    ...
    :param boolean show_training_progress: Show progress indicators for the
           trainer. The environment variable ``ChatterBox_SHOW_TRAINING_PROGRESS``
    ...
    def __init__(self, chatbot, **kwargs):
        ...
        environment_default = os.getenv('ChatterBox_SHOW_TRAINING_PROGRESS', True)
    ...
    class TrainerInitializationException(Exception):
        ...
        def __init__(self, message=None):
            default = (
                ...
                'See http://chatterbox.readthedocs.io/en/stable/training.html'
            )
...
class ChatterBoxCorpusTrainer(Trainer):
    """
    Allows the chat bot to be trained using data from the
    ChatterBox dialog corpus.
    """

    def train(self, *corpus_paths):
        from chatterbox.corpus import load_corpus, list_corpus_files
