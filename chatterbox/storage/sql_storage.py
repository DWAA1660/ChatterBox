from chatterbox.storage import StorageAdapter


class SQLStorageAdapter(StorageAdapter):
    """
    The SQLStorageAdapter allows ChatterBox to store conversation
    ...
    def get_statement_model(self):
        ...
        """
        from chatterbox.ext.sqlalchemy_app.models import Statement
        return Statement
    ...
    def get_tag_model(self):
        ...
        """
        from chatterbox.ext.sqlalchemy_app.models import Tag
        return Tag

    def model_to_object(self, statement):
        from chatterbox.conversation import Statement as StatementObject
    ...
    def create_database(self):
        ...
        """
        from chatterbox.ext.sqlalchemy_app.models import Base
