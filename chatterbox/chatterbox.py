...
from chatterbox.logic import LogicAdapter
from chatterbox.search import TextSearch, IndexedTextSearch
...
class ChatBot(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        storage_adapter = kwargs.get('storage_adapter', 'chatterbox.storage.SQLStorageAdapter')
