...
from chatterbox.exceptions import OptionalDependencyImportError
from chatterbox import languages
from chatterbox import parsing
...
class UnitConversion(LogicAdapter):
    ...
    :kwargs:
        * *language* (``object``) --
        The language is set to ``chatterbox.languages.ENG`` for English by default.
    """
